...
const event = () => {
    ...
    useEffect( () => {
        const get = async () => {
            const res = await axios.get(process.env.REACT_APP_API + "events/" + id);
            setEvent(res.data);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(process.env.REACT_APP_API + "events/" + localStorage.getItem("token") + "&id=" + id);
    ...
    const handleUpdate = async () => {
        try {
            await axios.put(process.env.REACT_APP_API + "events/" + localStorage.getItem("token") + "&id=" + id, {
                username: name,
                title: title,
                desc: desc
            });
